...
public class tela2 extends JFrame {
    ...
    /*private JButton getBtnDeletarPedido(){
        ImageIcon ImgFecharPedido = new ImageIcon("imagens/fecharLIXO.png");
        btnDeletarPedido = new JButton(ImgFecharPedido);
        btnDeletarPedido.setBounds(760, 528,130,175);
        btnDeletarPedido.setBorderPainted(false);
        btnDeletarPedido.setContentAreaFilled(false);
            ...
            public void actionPerformed(ActionEvent arg0) {
                ...
                if("".equals(listString)){
                    ...
                    int response = JOptionPane.showConfirmDialog(null, "Fechar pedido da "+listString+"?", "Confirmação",JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
                    if (response == JOptionPane.YES_OPTION){
                        ...
                        for(int i=0;i<lista.size();i++){
                            String reference = lista.get(i).reference;
                                if(reference.equals(listString)){
                                    id = lista.get(i).id;
                                }
                        }
                        try {
                        ...
                        JOptionPane.showMessageDialog(tela2.this,"Pedido da "+listString+" fechado!");
                    }
                }
            }
        });
